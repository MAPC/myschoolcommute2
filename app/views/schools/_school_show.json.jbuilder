...
json.shed_05 RGeo::GeoJSON.encode(school.to_wgs84('shed_05'))
json.shed_10 RGeo::GeoJSON.encode(school.to_wgs84('shed_10'))
json.shed_15 RGeo::GeoJSON.encode(school.to_wgs84('shed_15'))
json.shed_20 RGeo::GeoJSON.encode(school.to_wgs84('shed_20'))
